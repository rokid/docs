...
本文将讲解如何在Rokid技能平台上面实现技能，让你可以快速地创建一个自定义技能。
...
云端技能的后端服务可选择Rokid Force(无需后台服务器,详情请见[Rokid Force System使用指南](../rokid-force-system-tutorial.md))或者HTTPS([Java开发后端服务示例](https://github.com/Rokid/rokid-skill-sample/tree/master/rokid-skill-sample-java))。
...
本地技能的配置服务页面，需要上传APK，目前仅能够管理搭载开发版本若琪月石中的私有本地技能，其他设备请手动将APK推进机器中。
