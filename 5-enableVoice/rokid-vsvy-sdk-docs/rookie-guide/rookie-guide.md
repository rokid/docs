...
本文介绍如何通过“Rokid开放平台”获取SDK、配置产品技能、聊天以及系统升级管理系统。
...
- 若想使用技能配置页面上未显示的Rokid自有技能（系统技能），请您提供**typeID**（typeID是该类型产品的唯一标识）给商务（商务邮箱:rokidopen@rokid.com），商务协助人工授权。授权后您同意授权即可使用。
