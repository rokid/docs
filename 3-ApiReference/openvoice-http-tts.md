...
--header "Authorization:key=xxx;device_type_id=xxx;device_id=xxx;time=xxx;sign=xxx;" \
--data '{"text": "xxx", "declaimer":"zh", "codec":"mp3"}' \
--output output.mp3 \
https://apigwrest.open.rokid.com/api/v1/tts
```
### 设备认证
...
线上：<https://apigwrest.open.rokid.com/api/v1/tts>
